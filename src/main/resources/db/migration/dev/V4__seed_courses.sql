...
INSERT INTO courses (name, description, duration, subjects, fees, eligibility, schedule, instructor, active, created_at)
VALUES
    ('IIT-JEE Foundation',
     ...
     'Dr. Amit Sharma', TRUE, CURRENT_TIMESTAMP),
    ...
    ('NEET Medical',
     ...
     'Dr. Priya Singh', TRUE, CURRENT_TIMESTAMP),
    ...
    ('Class 10 Board Excellence',
     ...
     'Mrs. Kavita Verma', TRUE, CURRENT_TIMESTAMP),
    ...
    ('Class 12 PCM',
     ...
     'Mr. Sunil Gupta', TRUE, CURRENT_TIMESTAMP),
    ...
    ('Foundation Class 8-10',
     ...
     'Ms. Neha Joshi', TRUE, CURRENT_TIMESTAMP),
    ...
    ('Crash Course JEE Mains',
     'Intensive 3-month crash course covering the most important topics. Ideal for final revision.',
